...
export default function SetupScreen({setTitle, title}) {
    ...
    function constructBracket() {
        ...
        if (totalRounds === 1 && teams.length === 1) {
            ...
            initialBracket = {roundNum: 0, matches: [{id: 1, winner: null, team1: teams[0],
        ...
        // MAIN CASE: 2+ teams
            ...
            function pairTeams(teamsList, loPointer, hiPointer) {
                ...
                console.log("Number of matches in this round: " + numMatches)
            ...
            if (numByes > 0) {
                ...
                initialBracket = {roundNum: 0, matches: firstRoundMatches,
                    nextRound: nextRound};
            }
    ...
    return (
        <div className={"setup-cont"}>
            <div className={"setup-left"}>
                <button onClick={() => {console.log(bracket)}}>Testing button</button>
